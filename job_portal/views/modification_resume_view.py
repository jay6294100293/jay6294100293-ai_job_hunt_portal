...
def create_resume_meta_view(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            resume.status = 'created'  # Created from scratch
            resume.publication_status = Resume.DRAFT  # Always starts as draft
            resume.save()
        ...
        form = ResumeMetaForm(initial={'publication_status': Resume.DRAFT, 'visibility': Resume.VISIBILITY_PRIVATE})
