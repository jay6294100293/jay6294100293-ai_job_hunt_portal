...
from .views.preview_current_resume_view import preview_current_resume

from .views.resume_preview_view import template_preview_iframe
...
urlpatterns = [
    ...
    # Template preview URL - ADD THIS
    # path('templates/preview/<str:template_id>/', preview_template, name='preview_template'),
...
# Add this new URL for iframe-friendly preview
    path('templates/preview-iframe/<str:template_id>/', template_preview_iframe, name='template_preview_iframe'),
]
