"""
Django settings for ai_job_hunt project.
...
SECRET_KEY = 'django-insecure--$t)dzw53$0*zle-grzwn=eszr3x)#2x0_97cheo))e0ll#tk6'
...
WSGI_APPLICATION = 'ai_job_hunt.wsgi.application'
